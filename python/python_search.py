	...
	if request.method == "POST":
		...
		if len(risultati)>0:
			...
			for i in range(0,int(ris["numero"])):
				...
				testo_leo="<tr><td id='user"+str(i+1)+"'>"+str(stampante["varuser"])+"</td><td id='indirizzo"+str(i+1)+"'>"+str(stampante["varindirizzo"])+"</td><td id='citta"+str(i+1)+"'>"+str(stampante["varcitta"])+"</td><td id='mail"+str(i+1)+"'>"+str(stampante["varemail"])+"</td><td id='telefono"+str(i+1)+"'>"+str(stampante["vartelefono"])+"</td><td id='stampantetipo"+str(i+1)+"'>"+str(stampante["stampantetipo"])+"</td><td id='stampantenome"+str(i+1)+"'>"+str(stampante["stampantenome"])+"</td><td id='stampanteid"+str(i+1)+"'>"+str(stampante["stampanteid"])+"</td><td id='prezzo"+str(i+1)+"'>"+str(stampante["stampanteprezzo"])+"</td><td id='spedizione"+str(i+1)+"'>"+str(stampante["varspedizione"])+"</td><td id='consegna"+str(i+1)+"'>"+str(stampante["varconsegna"])+"</td><td id='distanza"+str(i+1)+"'>"+str(stampante["distanza"])+"</td><td><button onclick=gmail('"+str(i+1)+"','"+cookie+"')>Contatta con Gmail</button></td></tr>"
